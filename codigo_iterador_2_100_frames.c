...
{	
	...
	char filename[10];
	sprintf(filename,"%s-%s.txt",program,alg);
	...
	for(int i=2;i<=100;i++){ // eje
		...
		fprintf(file,"%d,%d,%d,%d\n",nframes,faults,rtodisk,wtodisk);
		
		
		//INICIALIZAMOS NUEVAMENTE LAS VARIABLES PARA LA SIGUIENTE ITERACION
